...
$name = $_POST['search'];
$pricemi = $_POST['preciomi'];
$pricema = $_POST['precioma'];
$semana = $_POST['week'];

$sql = "SELECT * FROM paquetes WHERE nombre LIKE '%$name%' and precio between $pricemi and $pricema and disponible='$semana' ";
...
echo '<h1 align="center">Reservar</h1> <br style="line-height:4; ">';
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<script>alert('No hay resultados acorde a su busqueda'); window.location.href=\"query2.php\"</script>";
}
