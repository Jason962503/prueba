...
?>
    ...
    <center><h1>Change personal information</h1></center>
    <br style="line-height:6; ">
    <center><label for="nombre"><h2>Name</h2></label></center>
    <center><input type="text" placeholder="<?php
          echo $nombre ; ?>" name="use" ></center>
     <br style="line-height:8; ">
    <center><label for="apellido"><h2>Last name</h2></label></center>
    <center><input type="text" placeholder="<?php
          echo $apellido ; ?>" name="apellido" ></center>
     <br style="line-height:8; ">
    <center><label for="Institucion"><h2>Group</h2></label></center>
    <center><input type="text" placeholder="<?php
          echo $institucion ; ?>" name="institucion" ></center>
     <br style="line-height:8; ">
    <center><label for="telefono"><h2>Phone number</h2></label></center>
    <center><input type="text" placeholder="<?php echo $telefono ?>" name="telefono" ></center>
     <br style="line-height:8; ">
     <center><label for="password"><h2>Set up new password</h2></label></center>
