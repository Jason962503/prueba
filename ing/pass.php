...
if (mysqli_connect_errno())
  ...
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
    ...
    if (!$result){ 
           echo "<script>alert('Your password was not changed'); window.location.href=\"logout.php\"</script>";
             //die("Database query failed.");
         exit;}
            else{
                
                echo "<script>alert('Your password was successfully change'); window.location.href=\"logout.php\"</script>";
