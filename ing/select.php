...
$sql = "SELECT * FROM paquetes2";
$result = mysqli_query($conn, $sql);

$connection = mysql_connect('localhost','root','Jason2010');
mysql_select_db('chiriqui',$connection);
...
echo '<h1 align="center">Table of pakages</h1> <br style="line-height:4; ">';
